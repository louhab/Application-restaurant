                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form method="post" action="<?php echo e(route('tables.store')); ?>" class="mb-3">
                             <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp5\htdocs\restaurant\resources\views/management/tables/create.blade.php ENDPATH**/ ?>